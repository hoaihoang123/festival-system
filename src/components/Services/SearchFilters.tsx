        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-4">
          <div className="flex gap-2 flex-1">
            <Button
              ...
              className="flex-shrink-0 bg-[hsl(var(--hero-btn))]  hover:bg-[hsl(var(--hero-btn))]/90 text-white hover:text-white/90"
            >
          ...
          <div className="flex gap-2 items-center ">
            ...
            <div className="flex border rounded-md overflow-hidden">
              <button
                ...
                className={
                  "flex items-center justify-center px-4 py-2 transition-colors focus:outline-none " +
                  (filters.viewType === "grid"
                    ? "bg-[hsl(var(--hero-btn))] text-white"
                    : "bg-white text-neutral-800 hover:bg-[hsl(var(--hero-btn))/10]")
                }
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 pt-4 border-t">
                ...
                <PopoverContent className="w-full p-0">
                  <Command>
                    ...
                    <CommandList>
                      ...
                      <CommandGroup>
                        <CommandItem
                          onSelect={() => updateFilter("location", "")}
                        >
                          Tất cả địa điểm
                        </CommandItem>
            ...
            <div className="space-y-2 md:col-span-2">
              ...
              <Slider
                ...
                min={0}
                step={1000000}
                className="w-full [&_.bg-primary]:bg-[hsl(var(--hero-btn))] [&_.border-primary]:border-[hsl(var(--hero-btn))]"
              />
            </div>
                  ...
                  <Badge variant="secondary" className="text-xs">
                    {
                      guestCountOptions.find(
                        (g) => g.value === filters.guestCount
                      )?.label
                    }
                    <X
                      className="ml-1 h-3 w-3 cursor-pointer"
                      onClick={() => updateFilter("guestCount", "all")}
                    />
                  </Badge>
                )}
              </div>
