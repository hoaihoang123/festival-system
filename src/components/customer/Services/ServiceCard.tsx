...
const ServiceCard = ({ service, viewType, animationDelay = 0 }: ServiceCardProps) => {
          ...
          <div className="flex-1 p-6">
            <div className="flex flex-col h-full">
              <div className="flex-1">
                <CardTitle className="text-xl font-bold text-gray-900 group-hover:text-primary transition-colors mb-2">
                  {service.title}
                </CardTitle>
